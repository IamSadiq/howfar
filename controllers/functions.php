...
function fetch_user_pics($width, $height){
	...
	$filePath='../assets/images/user_images/';
...
function printTitle(){
	switch ($_SERVER['PHP_SELF']) {
		...
		case '/HowFar/terms':
			echo 'HowFar | Terms';
			break;
		case '/HowFar/forgot-password':
			echo 'HowFar | Password Reset';
			break;
		case '/HowFar/view_user':
			echo 'HowFar | User';
			break;
